                ...
                <div className="w-full flex justify-between items-center">
                  ...
                  {project.inProgress ? (
                    <button
                      ...
                      className="w-12 h-12 lg:w-16 lg:h-16 rounded-full bg-white group-hover:bg-accent transition-all duration-500 flex justify-center items-center group-hover:-rotate-45"
                    >
