        ...
        <div className="space-y-10 text-sm lg:text-base lg:px-0">
            <section>
                <div className="text-primary-foreground/80 space-y-4 ">
                    ...
                    <p>The <span className="text-primary-foreground font-bold">Black-Scholes model (BSM)</span>, is a traditionally used mathematical option pricing framework, and relies on several key assumptions—constant volatility, a log-normal distribution of asset returns, and constant interest rates. These assumptions rarely hold true in real-world markets, limiting the model&apos;s ability to generalize effectively.</p>

                    <p>The inherent complexity of non-linear feature interactions in options pricing provides an opportunity to leverage machine learning (ML) models for better predictions. The ML models we employed include <span className="text-primary-foreground font-bold">Support Vector Regression (SVR)</span>, <span className="text-primary-foreground font-bold">Long Short-Term Memory (LSTM)</span> networks, and <span className="text-primary-foreground font-bold">Artificial Neural Networks (ANN)</span>.
                    </p>
            ...
            <section>
                ...
                <div className="space-y-4">
                    <p className="text-primary-foreground/80">
                        The <span className="text-primary-foreground font-bold">Black-Scholes model (BSM)</span>, developed in 1973, prices European-style options with significant and unrealistic assumptions (Constant volatility, log-normal distribution of asset returns, and assumption of constant interest rates). 
                    </p>
                    <p className="text-primary-foreground/80">
            ...
            <section className="">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-primary-foreground/80">
                        The <span className="text-primary-foreground font-bold">SVR</span> model outperformed <span className="text-primary-foreground font-bold">BSM</span>.
                    </p>
                </div>
            </section>
            ...
            <section>
                ...
                <div className="space-y-4">
                    ...
                    <section>
                        <p className="text-primary-foreground/80">
                            Our <span className="text-primary-foreground font-bold">LSTM</span> out performed our <span className="font-bold text-primary-foreground">SVR</span>, but was itself outperformed by our <span className="text-primary-foreground font-bold">ANN</span> approach below. Our group believes that our training data is a limiting factor in this situation, and with longer continuous time sequences of data performance will improve.
                        </p>
                    </section>
                </div>
            </section>
            ...
            <div>
                ...
                <div className="space-y-4">
                    <p className="text-primary-foreground/80">
                        Our final model, the <span className="font-bold text-primary-foreground">ANN</span>, is a deep learning model comprising an input layer for data features, hidden layers for processing, and an output layer for predictions. Its adaptability lies in adjusting weights and biases via back-propagation, making it ideal for tasks like option pricing and financial modeling.
                    </p>
                    <section className="flex flex-col md:flex-row gap-8 items-center ">
                        <div className="flex-1 order-2 lg:order-1">
                            <p className="text-primary-foreground/80">
                                Developing this model was my key contribution. Initially, a <span className="text-primary-foreground font-bold">&apos;Single-Stage ANN&apos;</span> was implemented with two hidden layers (64 and 32 nodes) and an output node for price prediction. However, this approach suffered from overfitting due to the dataset&apos;s noise, as it included numerous untraded options recorded with a closing price of zero. These zeros skewed the model and led to poor performance, necessitating a new approach.
                            </p>
                        </div>
                    ...
                    <section className="flex flex-col md:flex-row gap-8 items-center ">
                        <div className="flex-1 order-2 lg:order-1">
                            <p className="text-primary-foreground/80">
                                The most effective solution I devised was the <span className="text-primary-foreground font-bold">&apos;Two-Stage ANN&apos;</span>.
                                <br />
            ...
            <section>
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-primary-foreground/80">
                        Machine learning models such as <span className="font-bold text-primary-foreground">SVR</span>, <span className="font-bold text-primary-foreground">ANN</span>, and <span className="font-bold text-primary-foreground">LSTM</span> have demonstrated superior predictive power over BSM. However, these models require substantial time and computational resources to develop and are highly reliant on data quality. Overfitting and challenges in generalizing to extreme market conditions remain key concerns.
                    </p>
                    <p className="text-primary-foreground/80">
